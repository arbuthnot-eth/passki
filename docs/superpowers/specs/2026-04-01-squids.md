...
Mysten's SDK provides: Seal-encrypted messaging, off-chain satellite delivery, on-chain group permissions, key rotation, SuiNS integration, Walrus attachments. All between Sui wallets.
...
2. Signal is Seal-encrypted, routed via satellite (off-chain, cheap)
...
| **Thunder (satellite)** | Transport — encrypted message delivery, off-chain, low cost |
