...
- **Admin can revoke** — remove agent from Roster, extract DWalletCaps. Agent can no longer approve messages
- **User share re-encryption is one-way** — re-encrypting to an agent doesn't give the agent access to the admin's copy, and vice versa
